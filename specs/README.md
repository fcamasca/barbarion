...
| [H3.1-RAGContextOptimization](H3.1-RAGContextOptimization/) | Medición y optimización provider-agnostic del contexto RAG | Completada y aceptada; `baseline_v1` sigue default y `optimized_v1` permanece opt-in |
