...
| H3.1 Optimización de contexto RAG | Implementación iniciada; T01-T07 completadas, selección relevance-first disponible como opt-in | [Spec](specs/H3.1-RAGContextOptimization/) |
