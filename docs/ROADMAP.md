...
- **H3.1 — Optimización de contexto RAG:** completada y aceptada. `optimized_v1` queda disponible de forma opt-in sin promoverse; `baseline_v1` continúa como default hasta reunir validaciones adicionales en corpus distintos. La operación está en [`H31-RAG-CONTEXT.md`](H31-RAG-CONTEXT.md) y la evidencia final en [`../specs/H3.1-RAGContextOptimization/acceptance.md`](../specs/H3.1-RAGContextOptimization/acceptance.md).
