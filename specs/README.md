...
| [H3.1-RAGContextOptimization](H3.1-RAGContextOptimization/) | Medición y optimización provider-agnostic del contexto RAG | Implementación iniciada; T01 baseline completada |
