...
**Estado:** completada el 2026-08-08 por confirmación explícita del usuario.
...
El cierre conserva H3.3 como opt-in, adopta `balanced` como configuración
recomendada y mantiene diferida la promoción a default. La aceptación manual
multi-proveedor, el fallback conservador de presupuesto, su reconciliación de
observabilidad, la privacidad y las limitaciones conocidas quedan documentados
en `acceptance.md`.
