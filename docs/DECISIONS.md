...
| D-025 | 2026-08-07 | Aceptada | Validar inferencias sintácticas triviales y límites literales de evidencia con reglas acotadas | El soporte puramente léxico rechazaba `ROUND(...,2)` como “redondea a 2 decimales” y trataba toda declaración de ausencia como un claim positivo | Se aceptan patrones mecánicos explícitos, enumeraciones cuyos identificadores estén todos presentes y ausencias formuladas sobre la fuente cuyo objeto no aparezca literal ni sintácticamente; claims inventados y contradicciones siguen fallando |
| D-026 | 2026-08-07 | Aceptada | Exigir al menos una cita inline por cada párrafo o bullet factual | Validar solo que las citas usadas existieran permitía respuestas con una fuente válida y otros bloques factuales completamente sin citar | Encabezados, vacíos y bloques de código no cuentan; cualquier párrafo o bullet factual sin `[F<n>]` se registra como claim no soportado y activa el repair o el rechazo seguro vigente |
| D-027 | 2026-08-07 | Aceptada | Redistribuir desde cero el presupuesto de repair sobre las mismas fuentes de generation | Cuando generation consumía el presupuesto completo, agregar la respuesta rechazada hacía que repair excediera inevitablemente el mismo límite | Repair conserva IDs, candidatos, orden y trazabilidad, reduce proporcionalmente solo el contenido de evidencia y se ejecuta si el prompt reconciliado cabe y sigue respondiendo la pregunta; no hace retrieval nuevo ni aumenta el presupuesto |
| D-028 | 2026-08-07 | Aceptada | Compartir literalmente las reglas de grounding entre generation y repair | El prompt de repair solo pedía citas válidas y había divergido del contrato estricto por párrafo/bullet de generation | Ambos prompts reutilizan una única definición para cita factual, cita por bloque y prohibición de inferencias; repair agrega solo la instrucción de corregir soporte y citación |
| D-029 | 2026-08-07 | Aceptada | Hacer opcional `Supuestos y limites` y orientar un repair conservador con categorías seguras | La sección obligatoria inducía afirmaciones negativas accesorias, validaciones fallidas y una segunda llamada costosa aun cuando no aportaba evidencia | Generation y repair exigen respuestas compactas; la sección solo aparece ante límites explícitos citables; repair recibe categorías/conteos, no claims, y no puede agregar hechos; `repair_outcome` mide causa y eficacia sin tocar retrieval, presupuesto ni validador |
