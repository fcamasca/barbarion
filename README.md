...
| H3.1 Optimización de contexto RAG | Implementación iniciada; T01-T04 completadas, redundancia en diagnóstico report-only | [Spec](specs/H3.1-RAGContextOptimization/) |
